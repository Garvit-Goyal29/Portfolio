...
import './Home.css'
import resume from '../assets/Garvit Resume.pdf'
function Home() {
    return (
        <>
            <div className="w-full min-h-[84vh] md:h-[84vh] flex flex-col md:flex-row mb-[8vh] md:mb-[10vh]">
                ...
                <div className="relative w-full md:w-[50%] h-[55vh] sm:h-[62vh] md:h-full">
                    <div className="w-full h-full hidden md:block sm:scale-[0.8] md:scale-[0.85] relative bottom-[4vh] md:bottom-[6vh]">
                        <OptimizedSpline
                    ...
                    <a href={resume} download className="absolute md:relative bg-purple-400 hover:scale-[1.1] transition duration-100 bottom-[5vh] md:bottom-[20.1vh] left-[10vw] md:left-[5.2vw] px-4 md:px-[2.5vw] py-2 md:py-[1vh] w-[36vw] sm:w-[28vw] md:w-[15vw] rounded-full sora text-sm">My Resume</a>
                    <a href="#contact" className="absolute md:relative bg-purple-400 hover:scale-[1.1] transition duration-100 bottom-[5vh] md:bottom-[19.5vh] left-[54vw] sm:left-[44vw] md:left-[22vw] px-4 md:px-[2.5vw] py-2 md:py-[1vh] w-[36vw] sm:w-[28vw] md:w-[15vw] rounded-full sora text-sm">Reach out</a>
                </div>
            </div>
        </>
    )
